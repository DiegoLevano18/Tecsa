...
namespace CapaDatos
{
    public class Datos_DetalleCB
    {
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("sp_Ver_DetalleCB", cn);
        ...
        public string Crear_DetalleCB(DetalleCB oDetalleCB)
        {
            ...
            SqlCommand cmd = new SqlCommand("sp_Crear_DetalleCB", cn);
            cmd.CommandType = CommandType.StoredProcedure;

            // Asignado valores a los parámetros de entrada
            // Los valores se obtendrán de un objeto de la Entidad Cliente
            cmd.Parameters.AddWithValue("@idconductor", oDetalleCB.IdConductor);
            cmd.Parameters.AddWithValue("@idautobus", oDetalleCB.IdAutobus);
        ...
        public DataTable Buscar_DetalleCB(int Id)
        {
            ...
            cn.Open();
            SqlCommand cmd = new SqlCommand("sp_Buscar_DetalleCB", cn);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            cn.Open();
            SqlCommand cmd = new SqlCommand("sp_Actualizar_DetalleCB", cn);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@id", oDetalleCB.Id);
            cmd.Parameters.AddWithValue("@idconductor", oDetalleCB.IdConductor);
            cmd.Parameters.AddWithValue("@idautobus", oDetalleCB.IdAutobus);
        ...
        {
            cn.Open();
            SqlCommand cmd = new SqlCommand("sp_Eliminar_DetalleCB", cn);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@id", Id);
